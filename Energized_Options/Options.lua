...
local L = LibStub("AceLocale-3.0"):GetLocale("Energized", false)
local E = Energized
local mod = E:NewModule("Options")
					...
					warlock = {
						...
						args = {
							...
							warlockShards = {
								type = "select",
								name = L["Soul Shards"],
								desc = L["Determines how many soul shards Energized should expect, if any. This check is only performed when you are not in combat."],
								values = {
									["NONE"] = L["Don't check"],
									["3"] = L["Expect 3 soul shards"],
									["4"] = L["Expect 4 soul shards"],
								},
								get = function() return self.db.profile.warlockShards end,
								set = function(info, val)
									self.db.profile.warlockShards = val
									self:Update("OPTIONS")
								end,
								order = newOrder(),
							}, -- warlockShards
						...
						class = {
							...
							values = {
							 ["0"] = colorize(L["None"], GRAY_FONT_COLOR),
								...
								["MONK"] = colorize(L["Monk"], RAID_CLASS_COLORS["MONK"]),
							},
							get = function()
				...
				basic = {
				 ...
				 args = {
						...
						talentTree = {
							...
							desc = L["If this buff requires a specific specialization, choose one."],
						...
						talentWho = {
							...
							values = {
								["ANYONE"] = L["Anyone has this specialization"],
								["ME"] = L["I have this specialization"],
								["NOT_ME"] = L["I don't have this specialization"],
							},
							get = function()
